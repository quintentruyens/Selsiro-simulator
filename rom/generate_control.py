...
parser.add_argument("--output", "-o", help="The output file for this script", default=Path(__file__).parent / "control.bin", type=Path)

a = 0b0_0100_1100_0000_0000
...
def gen_control() -> Iterator[Ctrl]:
    for opcode in range(Opcode.OPCODE_MAX + 1):
        for funct3 in range(Funct3.FUNC3_MAX + 1):
            for funct7 in range(Funct7.FUNCT7_MAX + 1):
